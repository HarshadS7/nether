...
export default function SettingsPage() {
    ...
    const handleLogout = () => {
        // Clear all possible stored tokens and user data
        localStorage.removeItem("authToken");
        localStorage.removeItem("user");
        localStorage.removeItem("rawGithubToken");

        // Also clear any auth cookies if they were set on the client
                ...
                <Card className="bg-white border-[#E5E3E0] shadow-sm">
                    ...
                    <CardContent>
                        <Button
                            ...
                            className="bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 shadow-none font-semibold transition-colors disabled:opacity-50"
                        >
