...
import { MetricsChart } from "@/components/health/MetricsChart";
    ...
    return (
        <div className="flex h-full w-full flex-col p-6 overflow-y-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card className="bg-card col-span-2 lg:col-span-1 border border-border">
                    <CardHeader>
                ...
                <Card className="bg-[#FFB7B2]/20 col-span-2 lg:col-span-1 border border-border">
                    <CardHeader>
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-muted/50 border border-border shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className={`w-2 h-2 rounded-full ${comp.risk === "high" ? "bg-red-500 animate-pulse shadow-[0_0_8px_rgba(255,50,50,0.8)]" : "bg-yellow-500"}`}></span>
                                    </div>
                                </div>
                            ))}
                        </div>
