...
const navigation = [
  ...
  { name: "AI AI Assistant", href: "/chat", icon: MessageSquare },
  { name: "Architecture Blueprints", href: "/blueprints", icon: Layers },
    ...
    <div className="flex h-full w-64 flex-col border-r border-[#E5E3E0] bg-[#F8F7F5] text-[#231F20]">
      ...
      <div className="flex flex-col border-b border-[#E5E3E0]">
        <div className="flex h-14 items-center px-5 gap-3">
          ...
          <span className="font-black text-sm tracking-tight text-[#231F20]">Nether<span className="opacity-40">.ai</span></span>
        </div>
        ...
        <div className="px-4 pb-4">
          ...
          >
            <div className="flex items-center gap-2 overflow-hidden">
              ...
              <span className="font-mono text-xs font-semibold truncate leading-none pt-0.5">workspace repos</span>
            </div>
            <span className="text-[10px] text-[#6B6868] bg-[#F4F2F0] rounded px-1.5 py-0.5 border border-[#E5E3E0] shrink-0">Switch</span>
          </Link>
        </div>
      </div>
